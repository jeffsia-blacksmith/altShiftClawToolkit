---
name: best-practices-for-agent-skills
description: Use when creating, editing, or reviewing an Agent Skill SKILL.md, especially to improve frontmatter discoverability, instruction quality, progressive disclosure, deterministic scripts, and validation workflow. Do not use for general coding tasks unrelated to skill authoring.
---
